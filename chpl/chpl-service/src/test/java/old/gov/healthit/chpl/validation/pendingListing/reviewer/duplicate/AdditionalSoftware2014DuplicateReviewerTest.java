...
public class AdditionalSoftware2014DuplicateReviewerTest {
    ...
    public void setup() {
        ...
        }).when(msgUtil).getMessage(ArgumentMatchers.eq("listing.criteria.duplicateAdditionalSoftwareCP.2014"),
        ...
        }).when(msgUtil).getMessage(ArgumentMatchers.eq("listing.criteria.duplicateAdditionalSoftwareNonCP.2014"),
                ArgumentMatchers.anyString(), ArgumentMatchers.anyString(), ArgumentMatchers.anyString());
    }

package old.gov.healthit.chpl.auth;
...
public class CHPLAuthenticationSecurityTestConfig extends WebSecurityConfigurerAdapter implements EnvironmentAware {
    ...
    // and the table "user" is declared as "user" and not user (since user is a
    // reserved word
    // and perhaps not the best choice of table name). The syntax "delete from
    // user" is invalid

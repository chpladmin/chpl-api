package old.gov.healthit.chpl.app.permissions.domain.surveillance;
...
public class DeleteDocumentActionPermissionsTest extends ActionPermissionsBaseTest {
    @Mock
    private ResourcePermissions resourcePermissions;

    @InjectMocks
    private DeleteDocumentActionPermissions permissions;

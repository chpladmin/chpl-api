...
public class InvalidCriteriaCombinationReviewerTest {
    ...
    @Test
    public void review_b4OldAndB4RevisedCuresAttestedCertificationResults_hasError() {
        CertifiedProductSearchDetails listing = CertifiedProductSearchDetails.builder()
                .certificationResult(CertificationResult.builder()
                        .success(true)
                        .criterion(CertificationCriterion.builder()
                ...
                .certificationResult(CertificationResult.builder()
                        ...
                        .criterion(CertificationCriterion.builder()
                                .id(9L)
                                .number("170.315 (b)(4)")
                                .title("Criteria B4 Revised")
                                .build())
                        .build())
                .build();
        reviewer.review(listing);
        assertEquals(1, listing.getErrorMessages().size());
        assertTrue(listing.getErrorMessages().contains(String.format(INVALID_COMBINATION, "170.315 (b)(4)", "170.315 (b)(4)")));
    }

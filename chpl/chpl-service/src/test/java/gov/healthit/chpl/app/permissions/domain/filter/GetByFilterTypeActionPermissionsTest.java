package gov.healthit.chpl.app.permissions.domain.filter;
...
public class GetByFilterTypeActionPermissionsTest extends ActionPermissionsBaseTest {
    ...
    @InjectMocks
    private GetByFilterTypeActionPermissions permissions;

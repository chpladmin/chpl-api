...
import gov.healthit.chpl.surveillance.SurveillanceMockUtil;
...
public class RemovedCriteriaReviewerTest {
    ...
    @InjectMocks
    private PendingSurveillanceRemovedCriteriaReviewer reviewer;
    ...
    public void testOncAllowedToCreateSurveillanceWithRequirementWithRemovedCriteria() {
        ...
        Surveillance newSurveillance = mockUtil.createOpenSurveillance();

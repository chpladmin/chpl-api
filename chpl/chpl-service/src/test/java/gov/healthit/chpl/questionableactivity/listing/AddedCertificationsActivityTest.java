...
public class AddedCertificationsActivityTest {

    private CertificationCriterionService criteriaService;
    private AddedCertificationsActivity activityChecker;
    ...
    public void setup() {
        ...
        activityChecker = new AddedCertificationsActivity(criteriaService);
    }
    ...
    @Test
    public void check_a1AddedNothingRemoved_activityReturned() {
        CertifiedProductSearchDetails originalListing = CertifiedProductSearchDetails.builder()
                .certificationResult(CertificationResult.builder()
                        .criterion(a1)
                        .success(false)
        ...
        assertEquals(Util.formatCriteriaNumber(a1), activities.get(0).getAfter());
    }

    @Test
    public void check_a1AddedAndG10CuresAddedAndG8Removed_activityForA1Returned() {
        CertifiedProductSearchDetails originalListing = CertifiedProductSearchDetails.builder()
                .certificationResult(CertificationResult.builder()
                        .criterion(a1)
                        .success(false)
    ...
    @Test
    public void check_a1AddedAndB1CuresAddedAndG8Removed_activityForA1AndB1CuresReturned() {
        CertifiedProductSearchDetails originalListing = CertifiedProductSearchDetails.builder()
                .certificationResult(CertificationResult.builder()
                        .criterion(a1)
                        .success(false)
        ...
        assertEquals(Util.formatCriteriaNumber(a1), activities.get(0).getAfter());
        assertEquals(Util.formatCriteriaNumber(b1Cures), activities.get(1).getAfter());
    }

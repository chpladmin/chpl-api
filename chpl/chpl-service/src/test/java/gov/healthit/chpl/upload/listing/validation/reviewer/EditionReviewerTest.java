...
public class EditionReviewerTest {
    ...
    @Test
    public void review_nullEdition_hasError() throws ParseException {
    ...
    @Test
    public void review_editionObjectWithEmptyValues_hasError() throws ParseException {
    ...
    @Test
    public void review_editionObjectWithNoNameKey_hasError() throws ParseException {
        Mockito.when(errorMessageUtil.getMessage(ArgumentMatchers.eq("listing.missingEditionYear")))
            .thenReturn(MISSING_YEAR);
    ...
    @Test
    public void review_editionObjectWithNullValues_hasError() throws ParseException {
        Mockito.when(errorMessageUtil.getMessage(ArgumentMatchers.eq("listing.missingEditionYear")))
            .thenReturn(MISSING_YEAR);
    ...
    @Test
    public void review_editionObjectWithEmptyYearValidId_hasError() throws ParseException {
        Mockito.when(errorMessageUtil.getMessage(ArgumentMatchers.eq("listing.missingEditionYear")))
            .thenReturn(MISSING_YEAR);
    ...
    @Test
    public void review_editionObjectWithNullYearValidId_hasError() throws ParseException {
        Mockito.when(errorMessageUtil.getMessage(ArgumentMatchers.eq("listing.missingEditionYear")))
            .thenReturn(MISSING_YEAR);
    ...
    @Test
    public void review_editionObjectWithValidYearEmptyId_hasError() throws ParseException {
    ...
    @Test
    public void review_editionObjectWithValidYearNullId_hasError() throws ParseException {
        Mockito.when(errorMessageUtil.getMessage(ArgumentMatchers.eq("listing.invalidEdition"), ArgumentMatchers.anyString()))
        .thenAnswer(i -> String.format(INVALID_EDITION, i.getArgument(1), ""));
    ...
    @Test
    public void review_editionObjectWithValidYearMissingIdKey_hasError() throws ParseException {
        Mockito.when(errorMessageUtil.getMessage(ArgumentMatchers.eq("listing.invalidEdition"), ArgumentMatchers.anyString()))
        .thenAnswer(i -> String.format(INVALID_EDITION, i.getArgument(1), ""));
    ...
    @Test
    public void review_editionObjectWithValidYearAndId_noErrors() throws ParseException {
        Mockito.when(errorMessageUtil.getMessage(ArgumentMatchers.eq("listing.invalidEdition"), ArgumentMatchers.anyString()))
        .thenAnswer(i -> String.format(INVALID_EDITION, i.getArgument(1), ""));

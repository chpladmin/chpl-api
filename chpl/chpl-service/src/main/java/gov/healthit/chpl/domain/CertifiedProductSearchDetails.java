...
public class CertifiedProductSearchDetails implements Serializable {
    ...
    /**
     * The unique CHPL ID of the certified product. This variable is applicable
     * to 2014 and 2015 Edition. New uploads to CHPL will use the format:
    ...
    /**
     * Hyperlink to FULL Usability Test Report meeting all the SED requirements.
     * This variable is applicable for 2014 and 2015 Edition. Fully qualified
    ...
    /**
     * Date all SED testing was concluded for the Health IT. The format for the
     * date is YYYMMDD
     */
    @XmlElement(required = false, nillable = true)
     ...
     * Certification Edition. It is a string variable that does not have any
     ...
     * It is only applicable to 2014 Edition, and takes values of either
     * Complete EHR or Modular EHR.
     */
    @XmlElement(required = false, nillable = true)
    private Map<String, Object> classificationType = new HashMap<String, Object>();

    /**
     * If there was previously a different certifying body managing this listing
     * this is their name.
     */
    @XmlElement(required = false, nillable = true)
    ...
    /**
     * The version of the product being uploaded. This variable is applicable
    ...
    /**
     * For 2014 products, the practice setting for which the certified product
     * is designed. It takes value of Ambulatory or Inpatient.
     */
    @XmlElement(required = false, nillable = true)
    ...
    /**
     * The total number of open (unresolved) non-conformities found for the
     * corresponding listing. For additional information, please see
     * 'Understanding Surveillance Information in the CHPL', available in the
     ...
     * applicable for 2014 and 2015 Edition and contains the inherited status as
     * well as first-level parents and children.
     */
    @XmlElement(required = false, nillable = true)
    ...
    /**
     * The transparency attestation required by 170.523(k)(2). It is applicable
     * for 2014 and 2015 Edition and takes value of Affirmative, Negative, or
     * N/A.
     */
    @XmlElement(required = false, nillable = true)
    ...
    /**
     * A hyperlink to the mandatory disclosures required by 170.523(k)(1) for
    ...
    /**
     * This variable indicates that if there is the standard(s) or lack thereof
     * used to meet the accessibility-centered design certification criterion
     * for 2015 Certification Edtion. It is a string variable that does not have
     ...
     * capabilities/related criteria. This variable is applicable only for 2015
     ...
     * certification criterion. This variable is applicable for 2014 and 2015
     * Edition, and a string variable that does not take any restrictions on
     * formatting or values.
     */
    ...
    public void setAccessibilityStandards(final List<CertifiedProductAccessibilityStandard> accessibilityStandards) {

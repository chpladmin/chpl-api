...
public enum QuestionableActivityTriggerConcept implements Serializable {
    ...
    CRITERIA_B3_ADDED_TO_EXISTING_LISTING_WITH_ICS("Certification Criteria 170.315 (b)(3) added with ICS for current listing"),
    ...
    REAL_WORLD_TESTING_ADDED("Real World Testing Added to Listing not Real World Testing Eligible"),

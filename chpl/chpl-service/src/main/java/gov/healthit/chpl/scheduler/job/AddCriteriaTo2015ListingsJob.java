...
public class AddCriteriaTo2015ListingsJob extends QuartzJob {
    ...
    private void addMacraMeasureMaps() {
        ...
        addMacraMeasureMap("170.315 (b)(3)", "Electronic Prescribing (Cures Update)", "EC ACI Transition", "Electronic Prescribing: Eligible Clinician Individual (TIN/NPI)", "Required Test 1: Promoting Interoperability Transition Objective 2 Measure 1", false);
        addMacraMeasureMap("170.315 (b)(3)", "Electronic Prescribing (Cures Update)", "EC ACI", "Electronic Prescribing: Eligible Clinician Group", "Required Test 1: Promoting Interoperability Objective 2 Measure 1", false);
        ...
        addMacraMeasureMap("170.315 (e)(1)", "View, Download, and Transmit to 3rd Party (Cures Update)", "RT2b EC ACI Transition", "Patient Electronic Access: Eligible Clinician Group", "Required Test 2: Promoting Interoperability Transition Objective 3 Measure 1", false);
        ...
        addMacraMeasureMap("170.315 (e)(1)", "View, Download, and Transmit to 3rd Party (Cures Update)", "RT4a EC ACI", "View, Download, or Transmit (VDT): Eligible Clinician Group", "Required Test 4: Promoting Interoperability Objective 4 Measure 1", false);
        ...
        addMacraMeasureMap("170.315 (e)(1)", "View, Download, and Transmit to 3rd Party (Cures Update)", "RT4b EC ACI Transition", "View, Download, or Transmit (VDT): Eligible Clinician Group", "Required Test 4: Promoting Interoperability Transition Objective 3 Measure 2", false);
        addMacraMeasureMap("170.315 (e)(1)", "View, Download, and Transmit to 3rd Party (Cures Update)", "RT4b EC ACI", "View, Download, or Transmit (VDT): Eligible Clinician Group", "Required Test 4: Promoting Interoperability Objective 4 Measure 1", false);
    ...
    private void addMacraMeasureMap(String criterionNumber, String criterionTitle, String value, String name, String description, boolean removed) {

...
@NoArgsConstructor
@Entity
@Table(name = "real_world_testing_plan_summary_by_developer_report")
public class RealWorldTestingPlanSummaryByDeveloperReportEntity extends EntityAudit {
    private static final long serialVersionUID = -1291758504534058893L;

...
public class BusinessRulesOverrideNotifierMessage implements ChplTeamNotifierMessage {
    ...
    public BusinessRulesOverrideNotifierMessage(String chplProductNumber, JWTAuthenticatedUser user, ImmutableSortedSet<String> overriddenBusinessErrors, Environment env,

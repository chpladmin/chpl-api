...
public class UpdateMacraMeasuresJob extends QuartzJob {
    ...
    private void updateValues() {
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_1).getId(), "EH/CAH Stage 3", "EH/CAH Medicaid PI", "Required Test 10: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_1).getId(), "EP Stage 3", "EP Medicaid PI", "Required Test 10: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_2).getId(), "EH/CAH Stage 3", "EH/CAH Medicaid PI", "Required Test 11: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_2).getId(), "EP Stage 3", "EP Medicaid PI", "Required Test 11: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_3).getId(), "EH/CAH Stage 3", "EH/CAH Medicaid PI", "Required Test 12: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_3).getId(), "EP Stage 3", "EP Medicaid PI", "Required Test 12: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_10).getId(), "EC ACI", "RT1 EC", "Required Test 1: Merit-based Incentive Payment System (MIPS) Promoting Interoperability Performance Category");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_10).getId(), "EP Stage 3", "RT1 EP Medicaid PI", "Required Test 1: Medicaid Promoting Interoperability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_10).getId(), "RT14 EH/CAH Stage 3", "RT14 EH/CAH Medicare PI", "Required Test 14: Medicare Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_13).getId(), "EH/CAH Stage 3", "EH/CAH Medicaid PI", "Required Test 3: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.A_13).getId(), "EP Stage 3", "EP Medicaid PI", "Required Test 3: Medicaid Promoting Interoperability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_1_OLD).getId(), "RT15 EH/CAH Stage 3", "RT15 EH/CAH Medicare PI", "Required Test 15: Medicare Promoting Interoperability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_1_OLD).getId(), "RT7 EP Stage 3", "RT7 EP Medicaid PI", "Required Test 7: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_1_OLD).getId(), "RT8 EH/CAH Stage 3", "RT8 EH/CAH Medicaid PI", "Required Test 8: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_1_OLD).getId(), "RT8 EP Stage 3", "RT8 EP Medicaid PI", "Required Test 8: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_2_OLD).getId(), "EH/CAH Stage 3", "RT9 EH/CAH Medicaid PI", "Required Test 9: Medicaid Promoting Interoperability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_2_OLD).getId(), "EP Stage 3", "RT9 EP Medicaid PI", "Required Test 9: Medicaid Promoting Interoperability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_2_OLD).getId(), "RT15 EH/CAH Stage 3", "RT15 EH/CAH Medicare PI", "Required Test 15: Medicare Promoting Interoperability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_3_OLD).getId(), "EP Stage 3", "RT1 EP Medicaid PI", "Required Test 1: Medicaid Promoting Interopability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.B_3_OLD).getId(), "RT14 EH/CAH Stage 3", "RT14 EH/CAH Medicare PI", "Required Test 14: Medicare Promoting Interopability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_1_OLD).getId(), "RT2a EP Stage 3", "RT2a EP Medicaid PI", "Required Test 2: Medicaid Promoting Interopability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_1_OLD).getId(), "RT2b EP Stage 3", "RT2b EP Medicaid PI", "Required Test 2: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_1_OLD).getId(), "RT4a EH/CAH Stage 3", "RT4a EH/CAH Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_1_OLD).getId(), "RT4a EP Stage 3", "RT4a EP Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_1_OLD).getId(), "RT4b EH/CAH Stage 3", "RT4b EH/CAH Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_1_OLD).getId(), "RT4b EP Stage 3", "RT4b EP Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_2).getId(), "EH/CAH Stage 3", "EH/CAH Medicaid PI", "Required Test 5: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_2).getId(), "EP Stage 3", "EP Medicaid PI", "Required Test 5: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_3).getId(), "EH/CAH Stage 3", "EH/CAH Medicaid PI", "Required Test 6: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.E_3).getId(), "EP Stage 3", "EP Medicaid PI", "Required Test 6: Medicaid Promoting Interopability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_8).getId(), "RT2a EP Stage 3", "RT2a EP Medicaid PI", "Required Test 2: Medicaid Promoting Interopability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_8).getId(), "RT2c EP Stage 3", "RT2c EP Medicaid PI", "Required Test 2: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_8).getId(), "RT4a EH/CAH Stage 3", "RT4a EH/CAH Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_8).getId(), "RT4a EP Stage 3", "RT4a EP Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_8).getId(), "RT4c EH/CAH Stage 3", "RT4c EH/CAH Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_8).getId(), "RT4c EP Stage 3", "RT4c EP Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_9_OLD).getId(), "RT2a EP Stage 3", "RT2a EP Medicaid PI", "Required Test 2: Medicaid Promoting Interopability Program");
        ...
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_9_OLD).getId(), "RT2c EP Stage 3", "RT2c EP Medicaid PI", "Required Test 2: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_9_OLD).getId(), "RT4a EH/CAH Stage 3", "RT4a EH/CAH Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_9_OLD).getId(), "RT4a EP Stage 3", "RT4a EP Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_9_OLD).getId(), "RT4c EH/CAH Stage 3", "RT4c EH/CAH Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");
        updateMacraMeasuresDao.updateValueAndDescription(criteriaService.get(Criteria2015.G_9_OLD).getId(), "RT4c EP Stage 3", "RT4c EP Medicaid PI", "Required Test 4: Medicaid Promoting Interopability Program");

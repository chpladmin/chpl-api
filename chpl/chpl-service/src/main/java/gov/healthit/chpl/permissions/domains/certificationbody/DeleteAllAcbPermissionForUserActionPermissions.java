...
@Component("certificationBodyDeleteAllAcbPermissionForUserActionPermissions")
public class DeleteAllAcbPermissionForUserActionPermissions extends ActionPermissions {

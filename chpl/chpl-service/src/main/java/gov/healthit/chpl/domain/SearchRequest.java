...
public class SearchRequest implements Serializable {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((certificationStatuses == null) ? 0 : certificationStatuses.hashCode());
        result = prime * result + ((certificationEditions == null) ? 0 : certificationEditions.hashCode());
        result = prime * result + ((certificationCriteria == null) ? 0 : certificationCriteria.hashCode());
        result = prime * result + ((cqms == null) ? 0 : cqms.hashCode());
        result = prime * result + ((certificationBodies == null) ? 0 : certificationBodies.hashCode());
        result = prime * result + ((surveillance == null) ? 0 : surveillance.hashCode());
        result = prime * result + ((hasHadSurveillance == null) ? 0 : hasHadSurveillance.hashCode());
        ...
        result = prime * result + ((certificationDateStart == null) ? 0 : certificationDateStart.hashCode());
        result = prime * result + ((certificationDateEnd == null) ? 0 : certificationDateEnd.hashCode());
        result = prime * result + ((orderBy == null) ? 0 : orderBy.hashCode());
        result = prime * result + ((sortDescending == null) ? 0 : sortDescending.hashCode());

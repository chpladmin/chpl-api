...
private static final Logger LOGGER = LogManager.getLogger(ParticipantAgeStatisticsCalculator.class);
    ...
    private void initialize() {
        participantAgeStatisticsDAO = (ParticipantAgeStatisticsDAO) appEnvironment.getSpringManagedObject("participantAgeStatisticsDAO");
    ...
    private Map<Long, Long> getCounts(List<CertifiedProductSearchDetails> certifiedProductSearchDetails) {
    ...
    private void saveParticipantAgeStatistic(final ParticipantAgeStatisticsEntity entity) {
        try {
            ...
            LOGGER.info("Saved ParticipantAgeStatisticsDTO [Age Id: " + dto.getTestParticipantAgeId() + ", Count:" + dto.getAgeCount() + "]");

...
public class SurveillanceDataWorksheet {
    ...
    private static final Integer DATE_OF_DETERMINATION_INDEX = 18;
    private static final Integer CAP_APPROVAL_DATE_INDEX = 19;
    private static final Integer ACTION_BEGAN_DATE_INDEX = 20;
    private static final Integer MUST_COMPLETE_DATE_INDEX = 21;
    private static final Integer WAS_COMPLETE_DATE_INDEX = 22;
    private static final Integer NON_CONFORMITY_SUMMARY_INDEX = 23;
    private static final Integer NON_CONFORMITY_FINDINGS_INDEX = 24;
    private static final Integer SITES_PASSED_INDEX = 25;
    private static final Integer TOTAL_SITES_INDEX = 26;
    private static final Integer DEVELOPER_EXPLANATION_INDEX = 27;
    private static final Integer RESOLUTION_DESCRIPTION_INDEX = 28;
    private static final Integer DURATION_OF_CLOSED_SURVEILLANCE_INDEX = 29;
    private static final Integer TIME_TO_ASSESS_CONFORMITY_INDEX = 30;
    private static final Integer TIME_T0_APPROVE_CAP_INDEX = 31;
    private static final Integer MUST_COMPLETE_MET_INDEX = 32;
    private static final Integer DURATION_OF_CAP_INDEX = 33;
    private static final Integer TIME_FROM_CAP_APPROVAL_TO_SURVEILLANCE_CLOSE_INDEX = 34;
    private static final Integer TIME_FROM_CAP_CLOSE_TO_SURVEILLANCE_CLOSE_INDEX = 35;
    ...
    private Row populateSurveillanceRow(Row row, SurveillanceData surveillance) {
        ...
        setCellValueAsString(row.createCell(NON_CONFORMITY_STATUS_INDEX), surveillance.getNonconformityStatus());

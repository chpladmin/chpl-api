...
@Conditional(value = CertifiedProductDetailsManagerv2Condition.class)
public class CertifiedProductDetailsManagerv2 implements CertifiedProductDetailsManager {
    ...
    @Autowired
    public CertifiedProductDetailsManagerv2(

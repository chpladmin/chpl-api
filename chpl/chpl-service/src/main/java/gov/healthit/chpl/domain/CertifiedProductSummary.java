...
public class CertifiedProductSummary {
    private Long id;
    ...
    public CertifiedProductSummary() {

    }

    public CertifiedProductSummary(CertifiedProductSummaryDTO dto) {
    ...
    public String toString() {
        return "CertifiedProductSummary [id=" + id + ", certificationEditionId=" + certificationEditionId

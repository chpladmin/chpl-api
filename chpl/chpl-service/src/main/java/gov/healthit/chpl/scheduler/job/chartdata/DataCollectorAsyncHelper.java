...
public class DataCollectorAsyncHelper {
    ...
    /**
     * Retrieves the associated CertifiedProductionSearchDetails object as a
     * Future<>.
     * 
     * @param id
     *            id associated to the requested
     *            CertifiedProductionSearchDetails object
     * @param certifiedProductDetailsManager
     *            provides access to retrieve CertifiedProductionSearchDetails
     *            object
     * @return CertifiedProductionSearchDetails object
     * @throws EntityRetrievalException
     *             when the CertifiedProductionSearchDetails object could not be
     *             retrieved
     */
    @Async("chartDataExecutor")
    public Future<CertifiedProductSearchDetails> getCertifiedProductDetail(final Long id,
            final CertifiedProductDetailsManager certifiedProductDetailsManager) throws EntityRetrievalException {

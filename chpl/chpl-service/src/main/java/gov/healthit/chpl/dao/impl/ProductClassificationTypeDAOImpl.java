...
public class ProductClassificationTypeDAOImpl extends BaseDAOImpl implements ProductClassificationTypeDAO {
    ...
    private List<ProductClassificationTypeEntity> getAllEntities() {
        ...
        List<ProductClassificationTypeEntity> result = entityManager
                .createQuery("from ProductClassificationTypeEntity where (NOT deleted = true) ",
    ...
    private ProductClassificationTypeEntity getEntityByName(String name) {
        ...
        Query query = entityManager.createQuery(
                "from ProductClassificationTypeEntity where (NOT deleted = true) AND (name = :name) ",
                ProductClassificationTypeEntity.class);

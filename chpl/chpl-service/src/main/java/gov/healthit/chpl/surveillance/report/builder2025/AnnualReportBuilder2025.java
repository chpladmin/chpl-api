...
@Component("annualReportBuilder2025")
@NoArgsConstructor
public class AnnualReportBuilder2025 implements AnnualReportBuilderXlsx {
    ...
    @Autowired
    public AnnualReportBuilder2025(SurveillanceReportManager reportManager,

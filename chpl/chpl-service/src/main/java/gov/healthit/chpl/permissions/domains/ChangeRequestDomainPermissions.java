...
import gov.healthit.chpl.permissions.domains.changerequest.GetByDeveloperActionPermissions;
...
public class ChangeRequestDomainPermissions extends DomainPermissions {
    ...
    public static final String GET_BY_DEVELOPER = "GET_BY_DEVELOPER";
    ...
    public ChangeRequestDomainPermissions(
            ...
            @Qualifier("changeRequestGetByDeveloperActionPermissions") GetByDeveloperActionPermissions getByDeveloperActionPermissions,
        ...
        getActionPermissions().put(GET_BY_DEVELOPER, getByDeveloperActionPermissions);

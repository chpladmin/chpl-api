...
public class RwtResultsUrlChangedActivityProcessor extends SubscriptionSubjectProcessor {

    public RwtResultsUrlChangedActivityProcessor(SubscriptionSubject subject) {
        super(subject);
    }

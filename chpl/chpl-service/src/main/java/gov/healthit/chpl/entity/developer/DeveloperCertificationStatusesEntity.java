 ...
 * Table to store counts of certified products per certification_status for each
 * developer (vendor_id)
 *
...
public class DeveloperCertificationStatusesEntity implements Serializable {
    /** Serial Version UID. */

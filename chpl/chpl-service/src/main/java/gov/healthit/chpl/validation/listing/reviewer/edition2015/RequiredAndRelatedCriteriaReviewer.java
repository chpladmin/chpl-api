...
public class RequiredAndRelatedCriteriaReviewer implements ComparisonReviewer {
    private Environment env;
    private ErrorMessageUtil errorMessageUtil;
    private CertificationCriterionService criterionService;
    private ValidationUtils validationUtils;

    private CertificationCriterion g10Criteria;
    private List<CertificationCriterion> g10RequiredCriteria = new ArrayList<CertificationCriterion>();

    @PostConstruct
    public void postConstruct() {
        g10Criteria = criterionService.get(new Long(env.getProperty("criterion.170_315_g_10")));
    ...
    @Autowired
    public RequiredAndRelatedCriteriaReviewer(CertificationCriterionDAO certificationCriterionDao, Environment env,

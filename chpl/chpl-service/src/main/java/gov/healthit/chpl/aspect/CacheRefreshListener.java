...
/**
 * Reloads the main collections cache when needed.
 * Fetches the data in a separate cache and puts it in the live cache when complete. 
 * @author kekey
 *
 */
@Component
@Aspect
public class CacheRefreshListener implements EnvironmentAware {
     ...
     */
    @Autowired
    public CacheRefreshListener(final Environment env, final CertifiedProductDAO listingDao,

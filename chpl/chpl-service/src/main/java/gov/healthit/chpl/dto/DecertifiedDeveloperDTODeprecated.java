...
public class DecertifiedDeveloperDTODeprecated implements Serializable {
    ...
    public DecertifiedDeveloperDTODeprecated() {
    }

    public DecertifiedDeveloperDTODeprecated(Long developerId, List<Long> acbIdList, String developerStatus,

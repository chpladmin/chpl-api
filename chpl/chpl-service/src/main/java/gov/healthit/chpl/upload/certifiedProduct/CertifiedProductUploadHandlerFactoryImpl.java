...
public class CertifiedProductUploadHandlerFactoryImpl implements CertifiedProductUploadHandlerFactory {
    ...
    @Autowired
    private CertifiedProductHandler2015 handler2015;
    ...
    public CertifiedProductUploadHandler getHandler(CSVRecord heading, List<CSVRecord> cpRecords)
        ...
        if ((lastDataIndex + 1) == NUM_FIELDS_2014) {
            ...
            throw new InvalidArgumentsException("Expected " + NUM_FIELDS_2014 + " or " + NUM_FIELDS_2015
                    + " fields in the record but found " + (lastDataIndex + 1));
        }

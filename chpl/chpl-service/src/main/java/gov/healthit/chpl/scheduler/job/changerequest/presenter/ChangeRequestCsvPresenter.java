...
public abstract class ChangeRequestCsvPresenter implements AutoCloseable {
    ...
    protected static final String CR_QUESTION1_HEADING = "Information Blocking";
    protected static final String CR_QUESTION2_HEADING = "Assurances";
    protected static final String CR_QUESTION3_HEADING = "Communications";
    protected static final String CR_QUESTION4_HEADING = "Real World Testing";
    protected static final String CR_QUESTION5_HEADING = "Application Programming Interfaces";

...
public class IncumbentDevelopersStatisticsCalculator {
    ...
    public List<IncumbentDevelopersStatisticsDTO> getCounts(List<ListingSearchResult> certifiedProducts) {
        ...
        from2011To2014.setOldCertificationEditionId(certificationEditionDAO.getByYear("2011").getCertificationEditionId());
        from2011To2014.setNewCertificationEditionId(certificationEditionDAO.getByYear("2014").getCertificationEditionId());
        from2011To2015.setNewCount(0L);
        from2011To2015.setIncumbentCount(0L);
        from2011To2015.setOldCertificationEditionId(certificationEditionDAO.getByYear("2011").getCertificationEditionId());
        from2011To2015.setNewCertificationEditionId(certificationEditionDAO.getByYear("2015").getCertificationEditionId());
        from2014To2015.setNewCount(0L);
        from2014To2015.setIncumbentCount(0L);
        from2014To2015.setOldCertificationEditionId(certificationEditionDAO.getByYear("2014").getCertificationEditionId());
        from2014To2015.setNewCertificationEditionId(certificationEditionDAO.getByYear("2015").getCertificationEditionId());

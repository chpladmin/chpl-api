...
public class ConformanceMethodConversionJob extends CertifiedProduct2015Gatherer implements Job {
    ...
    private List<ConversionRule> getConversionRules() {
        return List.of(
                ...
                new ConversionRule(certificationCriterionService.get(CertificationCriterionService.Criteria2015.C_3_CURES), "ONC Test Method", "ONC Test Procedure", null),
                new ConversionRule(certificationCriterionService.get(CertificationCriterionService.Criteria2015.C_4), "ONC Test Method", "ONC Test Procedure", null),

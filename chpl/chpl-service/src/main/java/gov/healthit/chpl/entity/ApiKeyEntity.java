...
public class ApiKeyEntity {
	...
	@Id 
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "api_key_api_key_idGenerator")
	@Basic( optional = false )
	@Column( name = "api_key_id", nullable = false )
	@SequenceGenerator(name = "api_key_api_key_idGenerator", sequenceName = "api_key_api_key_id_seq")
	private Long id;

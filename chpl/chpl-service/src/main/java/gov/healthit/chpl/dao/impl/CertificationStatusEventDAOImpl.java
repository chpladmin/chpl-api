...
public class CertificationStatusEventDAOImpl extends BaseDAOImpl implements CertificationStatusEventDAO {
	...
	@Override
	public CertificationStatusEventDTO getById(Long id)
			throws EntityRetrievalException {
	...
	@Override
	public List<CertificationStatusEventDTO> findByCertifiedProductId(
	...
	public CertificationStatusEventDTO findInitialCertificationEventForCertifiedProduct(Long certifiedProductId) {
		CertificationStatusEventEntity certificationDateEvent = getOldestActiveEventForCertifiedProduct(certifiedProductId);

...
public enum Headings {
    ...
    TASK_TIME_DEV_OBS("Task Time Deviation - Observed Seconds", "Task Time Deviation - Mean Observed Seconds",
            "Task Time Deviation Observed"),
    TASK_TIME_DEV_OPT("Task Time Deviation - Optimal Seconds", "Task Time Deviation - Mean Optimal Seconds",
            "Task Time Deviation Optimal"),

...
public class ParticipantFriendlyIdReplacementDao extends BaseDAOImpl {

    @Transactional(rollbackOn = Exception.class)
    public void replaceParticipantFriendlyIds(CertifiedProductSearchDetails listing) throws EntityCreationException {
...
//        query.setParameter("systemUserId", ChplSystemUsers.SYSTEM_USER_ID);
...
//        try {
//            entity.setLastModifiedUser(ChplSystemUsers.SYSTEM_USER_ID);

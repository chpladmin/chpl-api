...
@Component
public class ChangeRequestApprovedValidation extends ValidationRule<ChangeRequestValidationContext> {
    ...
    public boolean isValid(ChangeRequestValidationContext context) {
        ...
        try {
            ...
            if (cr.getCurrentStatus().getChangeRequestStatusType().getId().equals(acceptedStatus)) {

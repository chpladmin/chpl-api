...
public class BulkEmailBuilder {
     ...
     */
    public BulkEmailBuilder(Environment env) {
        this.env = env;
    }
     ...
     */
    public BulkEmailBuilder recipients(List<String> addresses) {
     ...
     * @return EmailBuilder (this)
     */
    public BulkEmailBuilder recipients(String[] addresses) {
     ...
     * @return
     */
    public BulkEmailBuilder recipient(String address) {
     ...
     * @return EmailBuilder (this)
     */
    public BulkEmailBuilder subject(String val) {
        subject = val;
     ...
     * @return EmailBuilder (this)
     */
    public BulkEmailBuilder htmlMessage(String val) {
        htmlBody = val;
        return this;
    }

    public BulkEmailBuilder acbAtlHtmlFooter() {
    ...
    public BulkEmailBuilder publicHtmlFooter() {
        htmlFooter = String.format("<p>"
                + "If there are any questions about this process, please visit the "
                + "<a href=\"%s\">"
     ...
     * @return EmailBuilder (this)
     */
    public BulkEmailBuilder fileAttachments(List<File> val) {
        fileAttachments = val;
        return this;
    }
    ...
    private BulkEmailBuilder build() throws AddressException, MessagingException {
    ...
    public void bulkSendEmails() throws EmailNotSentException {
        Session session = Session.getInstance(getProperties(), getAuthenticator(getProperties()));

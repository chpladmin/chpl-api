...
public class CorrectiveActionPlanDAOImpl extends BaseDAOImpl implements CorrectiveActionPlanDAO {
    ...
    @Override
    public CorrectiveActionPlanDTO create(CorrectiveActionPlanDTO toCreate)
    ...
    public CorrectiveActionPlanEntity getEntityById(Long id) throws EntityRetrievalException {
        ...
        Query query = entityManager.createQuery(
                "from CorrectiveActionPlanEntity where (NOT deleted = true) AND (corrective_action_plan_id = :entityid) ",
                CorrectiveActionPlanEntity.class);
    ...
    private List<CorrectiveActionPlanEntity> getEntitiesByCertifiedProductId(Long id) {
        ...
        Query query = entityManager.createQuery(
                "from CorrectiveActionPlanEntity where (NOT deleted = true) AND (certified_product_id = :certified_product_id) ",
                CorrectiveActionPlanEntity.class);

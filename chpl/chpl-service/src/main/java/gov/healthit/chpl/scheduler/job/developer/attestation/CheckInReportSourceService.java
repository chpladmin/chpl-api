...
public class CheckInReportSourceService {
	...
	private ChangeRequest getMostRecentChangeRequest(Developer developer, AttestationPeriod period) {
		ChangeRequestSearchRequest request = ChangeRequestSearchRequest.builder().developerId(developer.getId())
				.changeRequestTypeNames(Set.of(ChangeRequestType.ATTESTATION_TYPE.toString())).build();

...
public class CertificationResult implements Serializable {
     ...
     * submitted for safety-enhanced design attestation during certification
     * testing. It is a binary variable that takes either true or false value,
     * and is only applicable to 2014 Edition.
     */
    @XmlElement(required = false, nillable = true)
    private Boolean sed;
    ...
    /**
     * This variable indicates if the corresponding certification criteria was
     * successfully tested for automated numerator recording. It is applicable
     * for the 2014 edition, and it is a binary variable that takes either true
     * or false value.
     */
    @XmlElement(required = false, nillable = true)
     ...
     * variable that takes either true or false, and is applicable to 2014
     * Edition.
     */
    @XmlElement(required = false, nillable = true)
     ...
     * criterion was addressed for the purposes of certification. It is
     * applicable for 2015 Edition and takes either of Approach 1 and Approach
     * 2.
     */
    @XmlElement(required = false, nillable = true)
     ...
     * only) capabilities within a certification criterion to which the Health
     * IT module was tested and certified. For example, within the 2015
     * certification criteria 170.315(a), the optional functionality to include
     * a 'reason for order' field should be denoted as (a)(1)(ii). You can find
     * a list of potential values in the 2014 or 2015 Functionality and
    ...
    /**
     * This variable indicates if any additional software is relied upon by the
     * Health IT Module to demonstrate its compliance with a certification
     * criterion or criteria. It is applicable for 2014 and 2015 Edition.
     */
    ...
    /**
     * A standard used to meet a certification criterion for 2014 and 2015
     * Edition. You can find a list of potential values in the 2014 or 2015
     * Functionality and Standards Reference Tables. Allowed values are the
     * corresponding paragraph number for the standard within the regulation.
     */
     ...
     * certification criteria Allowable values are based on the NIST 2014 and
     * 2015 Edition Test Tools. This variable is applicable for 2014 and 2015
     * Edition, and allowable values are based on the NIST 2014 and 2015 Edition
     * Test Tools: HL7 CDA Cancer Registry Reporting Validation Tool, HL7v2
     * Immunization Test Suite, HL7v2 Syndromic Surveillance Test Suite, HL7v2
     * Electronic Laboratory Reporting Validation Tool, Electronic Prescribing,
     * HL7 CDA National Health Care Surveys Validator, Edge Test Tool, 2015
     * Direct Certificate Discovery Tool, Cypress, HL7 v2 Electronic Laboratory
     * Reporting (ELR) Validation Tool, HL7 v2 Immunization Information System
     * (IIS) Reporting Validation Tool, HL7 v2 Laboratory Results Interface
     * (LRI) Validation Tool, HL7 v2 Syndromic Surveillance Reporting Validation
     * Tool
     */
     ...
     * This variable indicates if the corresponding certification criteria was
     * successfully tested for automated numerator recording. It is applicable
     * for the 2015 edition. The allowable values vary by certification
     * criteria, and include values such as "EP", "EH/CAH", "EP Individual",

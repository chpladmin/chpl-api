...
@Component("requiredAndRelatedCriteriaPreErdPhase2Reviewer")
public class RequiredAndRelatedCriteriaPreErdPhase2Reviewer  extends PermissionBasedReviewer {
    ...
    @Autowired
    public RequiredAndRelatedCriteriaPreErdPhase2Reviewer(CertificationCriterionService criterionService,

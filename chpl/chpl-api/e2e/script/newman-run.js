...
const searchActivityControllerTests = {
  ...commonOptions,
  collection: collection_path + '/search-activity-controller.postman_collection.json',
  reporter: {
    junit: {
      export: reports_path + '/search-activity-controller-tests.xml',
    },
  },
};

const searchDevelopersControllerTests = {
  ...commonOptions,
  collection: collection_path + '/search-developers.postman_collection.json',
  reporter: {
    junit: {
      export: reports_path + '/search-developers-controller-tests.xml',
    },
  },
};
...
const changerequestsControllerTests = {
  ...commonOptions,
  collection: collection_path + '/change-requests-controller.postman_collection.json',
  reporter: {
    junit: {
      export: reports_path + '/change-requests-controller-tests.xml',
    },
  },
};
...
const testToolsControllerTests = {
  ...commonOptions,
  collection: collection_path + '/test-tools-controller.postman_collection.json',
  reporter: {
    junit: {
      export: reports_path + '/test-tools-controller-tests.xml',
    },
  },
};
...
const reportDataControllerTests = {
  ...commonOptions,
  collection: collection_path + '/report-data.postman_collection.json',
  reporter: {
    junit: {
      export: reports_path + '/report-data-controller-tests.xml',
    },
  },
};

const reportDataCriteriaAttributesControllerTests = {
  ...commonOptions,
  collection: collection_path + '/report-data-criteria-attributes.postman_collection.json',
  reporter: {
    junit: {
      export: reports_path + '/report-data-criteria-attributes-controller-tests.xml',
    },
  },
};

const reportDataListingAttributesControllerTests = {
  ...commonOptions,
  collection: collection_path + '/report-data-listing-attributes.postman_collection.json',
  reporter: {
    junit: {
      export: reports_path + '/report-data-listing-attributes-controller-tests.xml',
    },
  },
};
...
const jobs = [
  ...
  cb => newman.run(searchDevelopersControllerTests,cb),

...
public class SchedulerController {
    ...
    @Operation(summary = "Get the list of all triggers of type '" + USER_JOB_TYPE + "' or '" + SYSTEM_JOB_TYPE + "' "
            ...
            description = "Security Restrictions: User must have either role chpl-admin, chpl-onc, or chpl-onc-acb "
                    + "for '" + USER_JOB_TYPE + "' jobs and have administrative authority on the specified ONC-ACB. "
                    + "User must have either role chpl-admin or chpl-onc for '" + SYSTEM_JOB_TYPE + "' jobs. "

...
public class SearchChangeRequestsController {
    ...
    @Operation(summary = "Search change requests on the CHPL",
            description = "This endpoint will always use the oldest, valid version of the "
                    + "/change-requests/search/vX endpoint. The current version being used is v2. For the "
                    + "current documentation, see /change-requests/search/v2.",
            security = {
    ...
    public @ResponseBody ChangeRequestSearchResponse search(
        ...
        return searchV2(searchTerm, developerId, currentStatusNamesDelimited, changeRequestTypeNamesDelimited,

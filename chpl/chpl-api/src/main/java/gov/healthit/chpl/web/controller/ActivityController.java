...
public class ActivityController {
    ...
    @Operation(summary = "Get metadata about auditable records in the system for the management of Conformance Methods.",
    ...
    @RequestMapping(value = "/metadata/conformance-methods", method = RequestMethod.GET,
            produces = "application/json; charset=utf-8")

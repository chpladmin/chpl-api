...
import gov.healthit.chpl.search.ListingSearchServiceV2;
...
public class SearchController {
    ...
    private ListingSearchServiceV2 searchServiceV2;

    @Autowired
    public SearchController(ListingSearchService searchService,
            ListingSearchServiceV2 searchServiceV2) {
        this.searchService = searchService;
        this.searchServiceV2 = searchServiceV2;
    }

    @DeprecatedApi(httpMethod = "POST", friendlyUrl = "/search", removalDate = "2023-08-30",
            message = "This endpoint has been deprecated and will be removed. Please GET from /search.")
    @Deprecated
    ...
    @DeprecatedApi(friendlyUrl = "/search", removalDate = "2023-08-30",
        message = "This endpoint is resolving to a deprecated endpoint. As of 2023-08-30 this endpoint will resolve to /search/v3. "
        + "The endpoint /search/v3 interprets date range start and end search parameters as inclusive.")
    ...
    @DeprecatedApi(httpMethod = "POST", friendlyUrl = "/search/v2", removalDate = "2023-08-30",
            message = "This endpoint has been deprecated and will be removed. Please GET from /search/v3.")
    @Deprecated
    @Operation(summary = "Search the CHPL with an HTTP POST Request.",
    ...
    public @ResponseBody ListingSearchResponse searchV2(@RequestBody SearchRequest searchRequest)
            throws ValidationException {
        return searchServiceV2.findListings(searchRequest);
    }

    @SuppressWarnings({
        "checkstyle:methodlength", "checkstyle:parameternumber"
    })
    @DeprecatedApi(friendlyUrl = "/search/v2", removalDate = "2023-08-30",
        message = "This endpoint has been deprecated and will be removed. Please use /search/v3.")
    @Deprecated
    @Operation(summary = "Search the CHPL",
    ...
    @DeprecatedApi(friendlyUrl = "/search/v4", removalDate = "2024-02-01",
        message = "This endpoint has been deprecated and will be removed. Please use /search/v4. The v4 endpoint does not allow filtering by edition.")
    @Deprecated
    @Operation(summary = "Search the CHPL",
            description = "If paging parameters are not specified, the first 20 records are returned by default. "
                    + "All parameters are optional. "
    ...
    public @ResponseBody ListingSearchResponse searchV4(
        @Parameter(description = "CHPL ID, Developer (or previous developer) Name, Product Name, ONC-ACB Certification ID",
                allowEmptyValue = true, in = ParameterIn.QUERY, name = "searchTerm")
        @RequestParam(value = "searchTerm", required = false, defaultValue = "") String searchTerm,
        @Parameter(description = "A comma-separated list of listing IDs to be queried together (ex: \"1,2\" finds the listing with ID 1 and the listing with ID 2.",

...
public class SearchController {
    ...
    public @ResponseBody ListingSearchResponse search(
            ...
            @Parameter(description = "A comma-separated list of Risk Management Summary Information search options. "
                    ...
                    allowEmptyValue = true, in = ParameterIn.QUERY, name = "riskManagementSummaryInformationOptions")
            @RequestParam(value = "riskManagementSummaryInformationOptions", required = false, defaultValue = "") String riskManagementSummaryInformationOptionsDelimited,
            @Parameter(description = "Either AND or OR. Defaults to OR."
                    + "Indicates whether a listing must have met all riskManagementSummaryInformationOptions specified or may have met any one or more of the riskManagementSummaryInformationOptions",
                    allowEmptyValue = true, in = ParameterIn.QUERY, name = "riskManagementSummaryInformationOperator")
        ...
        return searchV3(searchTerm, listingIdsDelimited, certificationStatusesDelimited, derivedCertificationEditionsDelimited,
                ...
                riskManagementSummaryInformationOperator, developer,
    ...
    public @ResponseBody ListingSearchResponse searchV3(
        ...
        SearchRequest searchRequest = SearchRequest.builder()
                ...
                .riskManagementSummaryInformationOperatorString(riskManagementSummaryInformationOperator)
                .developer(developer)
                .product(product)
                .version(version)
